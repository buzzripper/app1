...
namespace Dyvenix.App1.Integration.Shared.ApiClients;

public class IntegrationSystemApiClient : ISystemService
{
    public const string cUrlPathRoot = $"api/integration/system";

    private readonly HttpClient _httpClient;

    public IntegrationSystemApiClient(HttpClient httpClient)
    {
