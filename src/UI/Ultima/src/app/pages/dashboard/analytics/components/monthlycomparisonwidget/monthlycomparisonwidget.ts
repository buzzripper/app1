...
@Component({
    ...
    templateUrl: './monthlycomparisonwidget.html'
})
export class MonthlyComparisonWidget {
    layoutService = inject(LayoutService);

    @ViewChild('monthlyChart') chartViewChild!: UIChart;

    chartMonthlyData = signal<any>(null);

    chartMonthlyOptions = signal<any>(null);
