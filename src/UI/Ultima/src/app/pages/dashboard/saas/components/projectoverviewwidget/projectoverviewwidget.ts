...
import { SaasTableWidget } from '@/app/pages/dashboard/saas/components/saastablewidget/saastablewidget';
import { ButtonModule } from 'primeng/button';
import { RippleModule } from 'primeng/ripple';
import { TeamsWidget } from '@/app/pages/dashboard/saas/components/teamswidget/teamswidget';

@Component({
    selector: 'project-overview-widget',
    standalone: true,
    imports: [ButtonModule, RippleModule, TeamsWidget, SaasTableWidget],
    templateUrl: './projectoverviewwidget.html'
})
